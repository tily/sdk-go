...
func (a *API) resetImports() {
	a.imports = map[string]bool{
		"github.com/tily/sdk-go/aws": true,
	}
}
...
func (a *API) APIGoCode() string {
	a.resetImports()
	delete(a.imports, "github.com/tily/sdk-go/aws")
	a.imports["github.com/tily/sdk-go/aws/awsutil"] = true
	a.imports["github.com/tily/sdk-go/aws/request"] = true
	if a.OperationHasOutputPlaceholder() {
		a.imports["github.com/tily/sdk-go/private/protocol/"+a.ProtocolPackage()] = true
		a.imports["github.com/tily/sdk-go/private/protocol"] = true
	}

	for _, op := range a.Operations {
		if op.AuthType == "none" {
			a.imports["github.com/tily/sdk-go/aws/credentials"] = true
			break
		}
	}
...
func newClient(cfg aws.Config, handlers request.Handlers, endpoint, signingRegion, signingName string) *{{ .StructName }} {
	...
	// Handlers
	svc.Handlers.Sign.PushBackNamed({{if eq .Metadata.SignatureVersion "v2"}}v2{{else if eq .Metadata.SignatureVersion "s3"}}s3{{else}}v4{{end}}.SignRequestHandler)
...
func (a *API) ServiceGoCode() string {
	a.resetImports()
	a.imports["github.com/tily/sdk-go/aws/client"] = true
	a.imports["github.com/tily/sdk-go/aws/client/metadata"] = true
	a.imports["github.com/tily/sdk-go/aws/request"] = true
	if a.Metadata.SignatureVersion == "v2" {
		a.imports["github.com/tily/sdk-go/private/signer/v2"] = true
		a.imports["github.com/tily/sdk-go/aws/corehandlers"] = true
	} else if a.Metadata.SignatureVersion == "s3" {
		a.imports["github.com/tily/sdk-go/private/signer/s3"] = true
	} else {
...
func (a *API) InterfaceGoCode() string {
	a.resetImports()
	a.imports = map[string]bool{
		"github.com/tily/sdk-go/aws/request":           true,
